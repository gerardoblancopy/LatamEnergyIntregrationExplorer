...
const App: React.FC = () => {
  ...
  return (
    <div className="h-full bg-brand-bg text-brand-text-main p-3 flex flex-col">
      ...
      <div className="flex-grow flex flex-col-reverse lg:grid lg:grid-cols-12 gap-4 overflow-hidden">
        <div className="flex-1 lg:h-auto lg:col-span-4 xl:col-span-3 flex flex-col gap-4 overflow-y-auto lg:pr-2">
        ...
        <div className="h-[65vh] lg:h-auto lg:col-span-8 xl:col-span-9 flex flex-col">
          <div className="flex-grow bg-brand-surface border border-brand-border rounded-lg p-1 relative flex flex-col z-0">
            {loading && <Loader />}
